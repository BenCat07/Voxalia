    ...
    public class View3D
    {
        ...
        public void GenerateLightHelpers()
        {
            ...
            if (RS4P != null)
            {
                ...
                GL.DeleteFramebuffers(LIGHTS_MAX + 1, fbo_shadow);
            ...
            GL.TexImage3D(TextureTarget.Texture2DArray, 0, PixelInternalFormat.DepthComponent, sq, sq, LIGHTS_MAX + 1, 0, PixelFormat.DepthComponent, PixelType.Float, IntPtr.Zero);
            ...
            GL.GenFramebuffers(LIGHTS_MAX + 1, fbo_shadow);
        ...
        public void RenderPass_Setup()
        {
            ...
            if (TheClient.VR != null)
            {
                ...
                Matrix4 projo = TheClient.VR.GetProjection(true, 30f, 5000f);
            ...
            else
            {
                ...
                Matrix4 proj_out = Matrix4.CreatePerspectiveFieldOfView(MathHelper.DegreesToRadians(TheClient.CVars.r_fov.ValueF), (float)Width / (float)Height, 30f, 5000f); // TODO: View3D-level vars?
                ...
                Matrix4d proj_outd = Matrix4d.CreatePerspectiveFieldOfView(MathHelper.DegreesToRadians(TheClient.CVars.r_fov.ValueF), (float)Width / (float)Height, 30f, 5000f); // TODO: View3D-level vars?
