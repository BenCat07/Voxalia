    ...
    public class View3D
    {
        ...
        public void RenderPass_Setup()
        {
            ...
            if (TheClient.VR != null)
            {
                ...
                Matrix4 projo = TheClient.VR.GetProjection(true, 60f, TheClient.ZFarOut());
            ...
            else
            {
                ...
                Matrix4 proj_out = Matrix4.CreatePerspectiveFieldOfView(MathHelper.DegreesToRadians(TheClient.CVars.r_fov.ValueF), (float)Width / (float)Height, 60f, TheClient.ZFarOut()); // TODO: View3D-level vars?
                ...
                Matrix4d proj_outd = Matrix4d.CreatePerspectiveFieldOfView(MathHelper.DegreesToRadians(TheClient.CVars.r_fov.ValueF), (float)Width / (float)Height, 60f, TheClient.ZFarOut()); // TODO: View3D-level vars?
