    ...
    public class UIConsole
    {
        ...
        public static void Draw()
        {
            ...
            if (Open)
            {
                ...
                ConsoleTexture.Bind();
                Client.Central.CWindow.Rendering2D.SetColor(Color4.White);
                Client.Central.CWindow.Rendering2D.RenderRectangle(Client.Central.CWindow.MainUI.UIContext, 0, 0, Client.Central.Window.Width, Client.Central.Window.Height / 2);
                // Scrollbar
                Client.Central.Textures.White.Bind();
                Client.Central.CWindow.Rendering2D.RenderRectangle(Client.Central.CWindow.MainUI.UIContext, 0, 0, 2, Client.Central.Window.Height / 2);
                Client.Central.CWindow.Rendering2D.SetColor(Color4.Red);
                ...
                Client.Central.CWindow.Rendering2D.RenderRectangle(Client.Central.CWindow.MainUI.UIContext, 0, (int)(Y - Y * percenttwo), 2, (int)(Y - Y * percentone));
                // Bottom line
                Client.Central.Textures.White.Bind();
                Client.Central.CWindow.Rendering2D.SetColor(Color4.Cyan);
                Client.Central.CWindow.Rendering2D.RenderRectangle(Client.Central.CWindow.MainUI.UIContext, 0, (Client.Central.Window.Height / 2) - 1, Client.Central.Window.Width, Client.Central.Window.Height / 2);
                // Typing text
                string typed = Typing;
                int c = 0;
                        ...
                        if (str.Contains("^["))
                        {
                            ...
                            foreach (KeyValuePair<string, Rectangle2F> rectent in rects)
                            {
                                    ...
                                    && MouseHandler.MouseY() >= rectent.Value.Y && MouseHandler.MouseY() <= rectent.Value.Y + rectent.Value.Height)
                                {
                                    ...
                                    Client.Central.CWindow.Rendering2D.SetColor(Color4.Blue);
                                    Client.Central.CWindow.Rendering2D.RenderRectangle(Client.Central.CWindow.MainUI.UIContext, x, y, x + len + 5, y + 5 + hei);
                                    Client.Central.CWindow.Rendering2D.SetColor(Color4.LightGray);
                                    Client.Central.CWindow.Rendering2D.RenderRectangle(Client.Central.CWindow.MainUI.UIContext, x + 1, y + 1, x + len + 4, y + 4 + hei);
                                    Client.Central.CWindow.Rendering2D.SetColor(Color4.White);
